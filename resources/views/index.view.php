<script>
    function searchUsers() {
        ...
        console.log('Searching users for:', input.value);
...
<main class="px-4 bg-stone-100 h-screen w-full my-32">

    <h1 class="text-3xl text-center font-bold mb-8">
        User Database- Manage Your Users Easily
    </h1>

    <?php include('components/intro-flash.cp.php') ?>

    <!-- User Search -->
    <div class="container mx-auto px-8 py-4 bg-white rounded shadow shadow-sky-800 hover:shadow-lg mb-8 hover:shadow-sky-700">
    ...
    <!-- Users List -->
    <ul id="userList" class="mb-8 p-16 bg-white shadow rounded border-slate-100 hover:border-slate-200 border container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <?php foreach (data('users') as $user): ?>
            <li class="transition-all delay-100 duration-100 hover:translate-y-1 shadow-lg hover:shadow-2xl rounded-lg">
    ...
    <!-- Add User Form -->
    <form class="container mx-auto px-8 py-4 bg-white rounded shadow shadow-sky-800 hover:shadow-lg mb-8 hover:shadow-sky-700" method="POST" action="/add-user">
